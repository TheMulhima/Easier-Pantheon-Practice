...
## Description:
A mod that allows practice for P5 in HoG. This mod changes the health and damage of ascended bosses to match with P5. It also adds additional features such as giving the ability to remove health (for fury practice), add soul or add lifeblood before each fight starts. Also add an option for hitless practice.
